...
/** Homepage preview stays server-rendered and uses a tiny inline controller.
 * The full client slideshow is imported only by the dedicated gallery routes.
 */
    ...
    <section id="gallery" className={className}>
      <div className="container-page pt-18 md:pt-24">
        <div className="grid items-end gap-6 md:grid-cols-[1fr_auto]">
          ...
          <Button asChild variant="soft"><a href="/gallery" data-i18n-link><Images /><BiText en="Open full gallery" te="పూర్తి గ్యాలరీ" /><ArrowRight /></a></Button>
        </div>
      </div>
      <div className="mt-10 w-full"><InlineGalleryPreview /></div>
