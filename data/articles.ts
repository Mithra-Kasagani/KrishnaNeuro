...
export const articles: Article[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Treatment is not one-size-fits-all", paragraphs: ["Mild depression may improve with structured psychological treatment, activity, sleep support and follow-up. More severe, persistent or recurrent depression may benefit from medication alongside psychological and practical care.", "The plan should reflect prior response, health, pregnancy considerations, side effects, preferences and safety. Recovery is possible, but no ethical clinician can promise a guaranteed cure." ] },
