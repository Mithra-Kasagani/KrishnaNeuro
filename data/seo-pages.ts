...
export const coreSeoPages = {
  home: defineSeoPage({ pageTitle: "Psychiatrist in Vijayawada | Dr. Pamarthi Krishna Das", metaDescription: "Consult Dr. Pamarthi Krishna Das, Psychiatrist in Vijayawada, for psychiatric consultation, mental health care and treatment at Krishna Neuro Psychiatric Centre.", canonicalUrl: "/", h1: "Psychiatric & Mental Health Care in Vijayawada", schemaType: "MedicalWebPage", ogTitle: "Psychiatric & Mental Health Care in Vijayawada", ogDescription: "Professional, compassionate and confidential care at Krishna Neuro Psychiatric Centre in Vijayawada.", ogImage: "/opengraph-image", indexable: true, lastUpdated: "2026-08-05", author: "Krishna Neuro Psychiatric Centre" }),
