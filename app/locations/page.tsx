...
export const metadata: Metadata = createMetadata({ title: "Psychiatrist Near Vijayawada Neighbourhoods", description: "Find appointment and travel guidance for Krishna Neuro Psychiatric Centre from Benz Circle, Patamata, Poranki, Kanuru, Mangalagiri and nearby areas.", path: "/locations" });
